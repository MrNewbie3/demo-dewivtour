...
function Content() {
  return (
    <div className="">
      ...
      <div className="image">
        <div className="content-img bg-home-pattern  bg-cover h-80 my-10 mx-36 rounded-full">
          {" "}
        </div>
      </div>
            ...
            <div className="top-button">
              <div className=" justify-center flex ">
                <div className="wrapper p-2 bg-buttonDisabled rounded-full ">
                  <button className="btn btn-active bg-blueButton border-none rounded-full px-10 font-semibold text-base">
                    Tiket Masuk
                  </button>
                  <button className="btn btn-disabled text-textDisabled bg-buttonDisabled rounded-full  border-none font-semibold text-base">
                    Virtual Tour
                  </button>
                </div>
              </div>
